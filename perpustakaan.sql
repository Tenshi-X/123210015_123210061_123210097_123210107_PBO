...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2023 at 08:10 AM
...
(123210015, 'endricowisnu', 'projectpbo', 'admin'),
(123210025, 'yogapasaribu', 'yogapasaribu', 'user'),
(123210034, 'brammavizar', 'brammavizar', 'user'),
(123210061, 'sevagiantama', 'projectpbo', 'admin'),
(123210097, 'rizkygustiantoro', 'projectpbo', 'admin'),
(123210107, 'iqbalghozy', 'projectpbo', 'admin');
...
--
ALTER TABLE `user`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123210109;
